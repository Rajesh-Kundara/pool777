							...
							<div class="card mb-3">
								...
								<div class="card-body p-2">
									...
									<div class="form-group text-left">
									  ...
									  <input type="text" class="form-control" id="amount" placeholder="amount in kobo" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
									</div>
									<div class="form-group text-left">
									...
									<button type="button" onClick="addMoney()" class="btn btn-primary" id="btnAddMoney">Add</button>
									
									<div id="errorContainer" class="mt-2"></div>
								</div><input type="hidden" id="uId" value="<?=md5($_SESSION['id'])?>"/>
							</div>
						</form>
					</div>
				</td>
...
function addMoney(){
	...
	if(email.length==0 || amt.length==0){
		alert("Please enter correct values!"); return;
	}

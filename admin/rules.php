                            ...
                            <div class="col-md-12">
                                <div class="test_item fix">
									...
									<div class="row">
										...
										<div class="col-md-4"><h4><u>Expert's Rules</u></h4></div>
										<div class="col-md-4"></div>
									</div><br>
                                    <div class="row">
																 ...
																 <div class="panel panel-info"> 
																	 <div class='panel-body' style='font-size:82%;'>							 
																		<div class="form-group">
																			<label class='control-label col-md-13' for="workingHoursFrom">Rule Item :</label>
																			<div  class="col-md-13">
																		...
																		<form method="post"> 
																		<div class="form-group">
																			<label class='control-label col-md-13' for="workingHoursFrom">Rule Text</label>
																			<div  class="col-md-13">
																...
																<div class="panel panel-info"> 
																	...
																	$string ="<table id='DataGrid' align='center' width='100%' border='1' class='table dt-responsive'>
																			<thead>
																		  	...
																		  	<th width='67%' ><b align='center'>Rule</b></th>
																	...
																	$sql = "SELECT * FROM rules WHERE status='A'";
																	$stmt3 = $connection->query($sql);
																	if ( $stmt3 ){ 
																		while( $row3 = $stmt->fetch_assoc()( $stmt3)){ 
  ...
  function edit(formFillForEditId) {
	...
	function deleteItem(sr) {
		if(confirm('Are you sure you want to delete this Record?')){
			...
			$.ajax({  
			    type: "POST",  	
			    url: rootPath+"deleteInventoryItem.html",  

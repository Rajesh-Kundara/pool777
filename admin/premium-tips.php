...
<head>
	...
	<title>Admin Portal : Premium Tips</title>
...
if(!empty($_POST['saveButton']) || !empty($_POST['updateButton']))
{
	...
	if($id=="0"){
		if($isImageNull)
			$sql = "insert into tips_premium(text,date) values('$itemText',NOW())";	
		else
			$sql = "insert into tips_premium(text,imageUrl,date) values('$itemText','$files',NOW())";	
			
		$title="New Premium Tip added.";
		$message=$itemText;
	}else{
		if($isImageNull)
			$sql = "update tips_premium set text='$itemText',date=NOW() where id=$id";	
		else
			$sql = "update tips_premium set text='$itemText',imageUrl='$files',date=NOW() where id=$id";
	}
	//echo $sql;die;
	...
	if(strlen($title)>0){
		send_notification($title,$message,"premiumTips");
	}
	echo "<script>window.location.href='premium-tips.php'</script>";
}
?>	
                            ...
                            <div class="col-md-12">
                                <div class="test_item fix">
									...
									<div class="row">
										...
										<div class="col-md-4"><h4><u>Premium Tips</u></h4></div>
										<div class="col-md-4"></div>
									</div><br>
                                    <div class="row">
																...
																<div class="panel panel-info"> 
																	...
																	$string ="<table id='DataGrid' align='center' width='100%' border='1' class='table dt-responsive'>
																			<thead>
																		  	...
																		  	<th width='70%' ><b align='center'>Tip Text</b></th>
																	...
																	if ( $stmt3 ){ 
																		while( $row3 = $stmt3->fetch_assoc()){ 
																			$string=$string."<tr style='height:20px;color:black;'>
																				...
																				<td ><pre id='name_".$sr."' style='max-width:410px;word-wrap:break-word;display:block;'>".$row3['text']."</pre></td>
										...
										<div class="row">
											...
											<div class="col-md-7">
												...
												<?php
													...
													while($pRow = $pResult->fetch_assoc()($pResult)){
												?>
